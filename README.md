...
| `pucker_delta_pperp_hist.npz` | 2D (delta, Pperp) histogram over 3.2M residues, for `notebooks/supplemental_figures/figS6.ipynb`. Generated by the engine repo's `scripts/reference/extract_pucker_scatter.py`; committed (24 KB) rather than fetched. |
